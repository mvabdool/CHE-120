...
def runGame():
    ...
    # MA Loop that allows game to run
        ...
        if len(wormCoords) >= 1:
        #as long as the length of the worm is greater than or equal to one the worm will be ale to move.
            if direction == UP:
        ...
        #if the length of the worm is less than one then the game will end
            return # game over
